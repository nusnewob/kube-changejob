...
*/}}
{{- define "kube-changejob.fullname" -}}
...
*/}}
{{- define "kube-changejob.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "kube-changejob.resourceName" -}}
{{- $fullname := include "kube-changejob.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "kube-changejob.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "kube-changejob.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
